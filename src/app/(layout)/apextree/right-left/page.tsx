...
const ApexTreeRightLeftChart: NextPageWithLayout = () => {
  return (
    <React.Fragment>
      <BreadCrumb title="Right to Left" subTitle="Apextree" />
      <div className="grid grid-cols-12 gap-x-space">
        <div className="col-span-12 card">
          <div className="card-header">
            <h6 className="card-title">Right to Left</h6>
          </div>
...
export default ApexTreeRightLeftChart
