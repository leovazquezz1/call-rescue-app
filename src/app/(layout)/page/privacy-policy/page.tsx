        ...
        <div className="col-span-12 xl:col-span-8 xl:col-start-3">
          <div className="card">
            <div className="card-body">
              ...
              <ul className="mb-3 flex flex-col gap-2 list-inside list-circle">
                <li>
              ...
              <div className="py-5">
                <Image src={pr} alt="prImg" className="mx-auto max-h-44" />
              </div>
              <p className="mb-2 text-gray-500 dark:text-dark-500">
              ...
              <p className="mb-3 text-gray-500 dark:text-dark-500">
                ...
                If you&apos;re using an Android device with Google apps, your
                device periodically contacts Google servers to provide
                information about your device and connection to our services.
                This information includes things like your device type and
                carrier name, crash reports, which apps you&apos;ve installed,
                and, depending on your device settings, other information about
                how you&apos;re using your Android device.
              </p>
              ...
              <div className="flex justify-end gap-2 mt-5">
                ...
                <Link href="#!" className="border-dashed btn btn-dashed-red">
                  I Disagree
                </Link>
              </div>
            </div>
