...
import contactImage from '@assets/images/hospital/landing/contact.png'
import { MoveLeft, MoveRight } from 'lucide-react'

const GetYourAppointment: React.FC = () => {
  return (
    <React.Fragment>
      <section className="relative pt-14 md:pt-28">
        <div className="container mx-auto px-4 xl:px-20">
          ...
          <div className="grid items-center grid-cols-1 lg:grid-cols-2 gap-x-20">
            <div>
              <form action="#!">
                <div className="grid items-center grid-cols-12 gap-space">
                  <div className="col-span-12 md:col-span-6">
                    <input
                      type="text"
                      className="h-12 border-t-0 rounded-none border-x-0 dark:bg-transparent form-input focus:border-b-sky-500"
                  ...
                  <div className="col-span-12">
                    <textarea
                      className="h-auto border-t-0 rounded-none border-x-0 dark:bg-transparent form-input focus:border-b-sky-500"
                      rows={3}
                  ...
                  <div className="col-span-12 md:col-span-6">
                    <p className="text-gray-500">
                      Please Call Us:
                      <Link href="#!" className="font-medium text-sky-500">
                        +241 01234 567 89
                      </Link>
                    </p>
                  </div>
                  <div className="col-span-12 text-right md:col-span-6">
            ...
            <div>
              <div className="relative mt-8 lg:ml-12 lg:mt-0">
                <div className="absolute left-10 sm:left-40 lg:left-0 xl:left-42 2xl:left-48 bottom-1/2 size-52 md:size-96 bg-sky-500/15 blur-3xl"></div>
                <Image
                  src={contactImage}
                  alt="contactImage"
          ...
          <div className="relative p-12 -mb-20 overflow-hidden rounded-md bg-sky-500 text-sky-50">
            <div className="absolute inset-0">
              <svg
                ...
                <g mask='url("#SvgjsMask1007")' fill="none">
                  <path
                    className="stroke-sky-300 opacity-10"
                  ...
                  <path
                    className="stroke-sky-300 opacity-15"
            ...
            <div className="relative items-center justify-between lg:flex md:gap-x-8">
              <div className="xl:max-w-[400px]">
                <h5 className="mb-3 text-3xl leading-normal capitalize">
                  Don&apos;t delay care for you amd those you love
                </h5>
                <p className="text-sky-100 text-16">
                  &quot;Healthy living&quot; to most people means both physical
                  and mental health are in balance or functioning well together.
                </p>
              </div>
              <div className="mt-4 lg:mt-0">
                <button
                  type="button"
                  className="font-medium bg-white hover:bg-white focus:bg-white btn py-2.5 btn-active-sky hover:text-sky-500 focus:text-sky-500">
                  Stay Connect{' '}
                  <MoveRight className="inline-block ml-1 rtl:hidden size-4 mb-0.5" />
                  <MoveLeft className="hidden mr-1 rtl:inline-block size-4 mb-0.5" />
                </button>
              </div>
            </div>
          </div>
